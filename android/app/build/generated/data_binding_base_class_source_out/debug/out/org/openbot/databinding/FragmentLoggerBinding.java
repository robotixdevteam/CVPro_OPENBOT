...
public final class FragmentLoggerBinding implements ViewBinding {
  ...
  public static FragmentLoggerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.analyseText;
      TextView analyseText = ViewBindings.findChildViewById(rootView, id);
      if (analyseText == null) {
        break missingId;
      }
      ...
      ConstraintLayout loggerBottomSheet = ViewBindings.findChildViewById(rootView, id);
      ...
      CheckBox previewCheckBox = ViewBindings.findChildViewById(rootView, id);
      ...
      Button sensorDataButton = ViewBindings.findChildViewById(rootView, id);
      ...
      Spinner serverSpinner = ViewBindings.findChildViewById(rootView, id);
      if (serverSpinner == null) {
        break missingId;
      }

      id = R.id.trainingDataCheckBox;
      CheckBox trainingDataCheckBox = ViewBindings.findChildViewById(rootView, id);
